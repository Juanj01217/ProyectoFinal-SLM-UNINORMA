...
Desde esta carpeta raíz del proyecto (`/`), ejecutar:

```bash
docker compose up
```

**Primera ejecución:** descarga automáticamente el modelo qwen2.5:1.5b (~2 GB). Puede tardar 5-15 minutos dependiendo de la conexión. No interrumpir.
